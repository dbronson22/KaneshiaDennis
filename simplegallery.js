...
var simpleGallery_navpanel={
	loadinggif: 'Pictures/Slide/ajaxload.gif', //full path or URL to loading gif image
	panel: {height:'50px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 11px Verdana'}, //customize nav panel container
	images: [ 'Pictures/Slide/left.gif', 'Pictures/Slide/play.gif', 'Pictures/Slide/right.gif', 'Pictures/Slide/pause.gif'], //nav panel images (in that order)
